...
#[repr(C)]
#[derive(Copy)]
pub struct Struct_nfc_emulator {
    pub target: *mut nfc_target,
    pub state_machine: *mut Struct_nfc_emulation_state_machine,
    pub user_data: *mut ::libc::c_void,
}
impl ::std::clone::Clone for Struct_nfc_emulator {
    fn clone(&self) -> Self { *self }
}
impl ::std::default::Default for Struct_nfc_emulator {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy)]
pub struct Struct_nfc_emulation_state_machine {
    pub io: ::std::option::Option<unsafe extern "C" fn(emulator:
                                                           *mut Struct_nfc_emulator,
                                                       data_in:
                                                           *const uint8_t,
                                                       data_in_len: size_t,
                                                       data_out: *mut uint8_t,
                                                       data_out_len: size_t)
                                      -> ::libc::c_int>,
    pub data: *mut ::libc::c_void,
}
impl ::std::clone::Clone for Struct_nfc_emulation_state_machine {
    fn clone(&self) -> Self { *self }
}
impl ::std::default::Default for Struct_nfc_emulation_state_machine {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
extern "C" {
    ...
    pub fn str_nfc_target(buf: *mut *mut ::libc::c_char,
     ...
     -> ::libc::c_int;
    pub fn nfc_emulate_target(pnd: *mut nfc_device,
                              emulator: *mut Struct_nfc_emulator,
                              timeout: ::libc::c_int) -> ::libc::c_int;
}
